...
execute positioned ~ ~2 ~ if score *players3 Players matches 1.. run function genanim
execute positioned ~ ~ ~ if score *players3 Players matches 1.. run function hack_effect3