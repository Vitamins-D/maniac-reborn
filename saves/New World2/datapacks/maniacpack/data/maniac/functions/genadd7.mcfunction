...
execute positioned ~ ~2 ~ if score *players7 Players matches 1.. run function genanim
execute positioned ~ ~ ~ if score *players7 Players matches 1.. run function hack_effect7