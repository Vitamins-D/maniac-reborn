...
execute if score comp2 hackGoal matches 0 if score temp_percent temp_calc matches 51..75 run data modify entity @e[type=text_display,tag=hack2Eff,distance=..5,limit=1] text set value '[{"score":{"name":"temp_percent","objective":"temp_calc"},"color":"orange","bold":true},{"text":"%","color":"white"}]'
execute if score comp2 hackGoal matches 0 if score temp_percent temp_calc matches 76..99 run data modify entity @e[type=text_display,tag=hack2Eff,distance=..5,limit=1] text set value '[{"score":{"name":"temp_percent","objective":"temp_calc"},"color":"green","bold":true},{"text":"%","color":"white"}]'
...
execute if score comp2 hackGoal matches 1 run data modify entity @e[type=text_display,tag=hack2Eff,distance=..5,limit=1] text set value '[{"text":"COMPLETED","color":"lime","bold":true}]'
