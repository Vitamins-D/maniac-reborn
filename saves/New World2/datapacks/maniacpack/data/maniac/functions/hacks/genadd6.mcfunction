execute positioned ~ ~2 ~ as @a[distance=..2.5,gamemode=adventure,team=survivors,limit=4] if score comp6 hackGoal matches 0 run scoreboard players add Progress6 hack 10
