...
execute positioned ~ ~2 ~ if score *players9 Players matches 1.. run function maniac:hacks/genanim
execute positioned ~ ~ ~ if score *players9 Players matches 1.. run function maniac:hacks/hack_effect9