...
execute as @e[tag=class_marker_scientist] at @s run summon minecraft:text_display ~ ~-1.3 ~ {Tags:["class_display_scientist","abilities_page_scientist"],text:'{"text":"  Ваши знания позволяют\\nбыстрее взламывать\\nкомпьютеры","color":"white"}',Rotation:[90f,0f],shadow:1b,background:0b}
