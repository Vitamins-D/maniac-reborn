...
execute as @e[tag=class_marker_dependent] at @s run summon minecraft:text_display ~ ~-0.9 ~0.2 {Tags:["class_display_dependent","items_page_dependent"],text:'{"text":"Шприц мефедрона\\n","color":"white"}',Rotation:[90f,0f],shadow:1b,background:0b}
...
execute as @e[tag=class_marker_dependent] at @s run summon minecraft:text_display ~ ~-2.1 ~0.2 {Tags:["class_display_dependent","items_page_dependent"],text:'{"text":"Дуделка)))\\n","color":"white"}',Rotation:[90f,0f],shadow:1b,background:0b}
